...
const frRootPageContent = {
  metadata: {
    ...
    description:
      "Créez des overlays de compte à rebours dans votre navigateur. Prévisualisez instantanément et exportez une séquence PNG transparente ou du WebM pour le montage.",
  },
  generatorHero: {
