...
const jaRootPageContent = {
  ...
  seoSection: {
    ...
    faqItems: [
      {
        question: "動画にオーバーレイタイマーを追加するには？",
        answer:
          "上の生成ツールで長さとスタイルを設定し、書き出します。最も確実な透過オーバーレイタイマーが必要ならPNGシーケンス、単一の透過動画ファイルが必要ならWebMを選び、CapCut、Premiere Pro、Final Cut Pro、DaVinci Resolve、OBS などで映像の上のレイヤーに重ねてください。",
      },
      {
        question: "OBS や Twitch 向けの透過オーバーレイタイマーは作れますか？",
        answer:
          "はい。WebM（透過）形式で書き出し、OBS、Streamlabs、Twitch Studio に動画レイヤーとして追加します。背景はすでに切り抜かれているため、追加のクロマキー処理なしでカウントダウンがシーンの上にきれいに重なります。",
      },
      {
        question:
          "オーバーレイタイマーとカウントダウンオーバーレイの違いは何ですか？",
        answer:
          "通常は同じものを指します。設定した長さからゼロまで動画の上でカウントダウンするオーバーレイタイマーです。このツールはカウントダウン式のオーバーレイタイマーを作成するので、合計秒数を設定し、MM:SS などの表示形式を選んで、編集ソフト向けに書き出してください。",
      },
      {
